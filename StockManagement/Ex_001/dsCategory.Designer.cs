...
namespace Ex_001.dsCategoryTableAdapters {
    ...
    public partial class tblCategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[tblCategory] SET [CategoryName] = @CategoryName WHERE (([CategoryId" +
                "] = @Original_CategoryId) AND ([CategoryName] = @Original_CategoryName));\r\nSELEC" +
                "T CategoryId, CategoryName FROM tblCategory WHERE (CategoryId = @CategoryId)";
        ...
        public virtual int Fill(dsCategory.tblCategoryDataTable dataTable) {
        ...
        public virtual dsCategory.tblCategoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsCategory.tblCategoryDataTable dataTable = new dsCategory.tblCategoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsCategory.tblCategoryDataTable dataTable) {
